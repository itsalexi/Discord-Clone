        ...
        <div className="register">
            <div className="register-box">
                ...
                <form className="register-form">
                    <label htmlFor="register_email" className="register_label">
                        EMAIL
                    </label>
                    <input
                        type="email"
                        ...
                        required={true}
                    />
                    <label htmlFor="register_user" className="register_label">
                        USERNAME
                    </label>
                    <input
                        type="text"
                ...
                <p className="register__tos">
                    ...
                    <Link className="register__link">Terms of Service</Link> and{' '}
