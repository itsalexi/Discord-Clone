                ...
                <ul className="guilds-container">
                    <li className="guild-container blurple">
                        ...
                        <div className="tooltip-container">
                            <h4 className="tooltip-text">Home</h4>
                        </div>
                    </li>
                    ...
                    <li className="guild-container blurple">
                        <img
                            src="https://cdn.discordapp.com/icons/1031097804682178592/8ee79450b7ad415709b25517858e4531.webp?size=1024"
                            alt=""
                            className="server-icon"
                        />

                        <div className="tooltip-container">
                            <h4 className="tooltip-text">alexi | playground</h4>
                        </div>
                    </li>
                    <li className="guild-container blurple">
                        <img
                    ...
                    <li className="guild-container green">
                        <svg
                        ...
                        <div className="tooltip-container">
                            <h4 className="tooltip-text">Add Server</h4>
                        </div>
                    </li>
                    <li className="guild-container green">
                        <svg
                    ...
                    <section className="panel">
                        <div className="user-info">
                            <div className="avatar-wrapper">
                                <img
                                    className="avatar"
                                    src="https://cdn.discordapp.com/avatars/571238926451212288/bee15463914b38ed11a8185f206ed374.webp?size=512"
                                    alt="avatar"
                                />
